...
public class MD5Utils {
     ...
     * @throws Exception
     */
    public static byte[] encrypte ( byte[] salt, String password) throws Exception {
        try {
            //声明消息摘要对象
    ...
    public static void main (String[]args) throws Exception {
        ...
        // 验证输入的密码是否正确
        // 查看密码是否正确
        System.out.println(validPassword("kawayi", encryptedPwd)); //true
        System.out.println(validPassword("kawayii",encryptedPwd)); //false
    }
}
